...
const mockProducts = {
    ...
    banana: [
        {
            title: 'Fresh Yellow Bananas per lb',
            price: '0.69',
            original_price: '0.79',
            availability: 'in_stock',
            unit: 'lb',
            url: 'https://www.loblaws.ca/en/products/bananas',
            discount: '13%',
        },
        {
            ...
            availability: 'in_stock',
            unit: 'lb',
            url: 'https://www.loblaws.ca/en/products/organic-bananas',
            discount: '23%',
        },
    ],
    bread: [
        {
            title: 'Canada Bread White Bread 600g',
            price: '2.49',
            original_price: '2.99',
            availability: 'in_stock',
            unit: '600g',
            url: 'https://www.loblaws.ca/en/products/white-bread',
            discount: '17%',
        },
        {
            title: 'Whole Wheat Bread 700g',
            price: '2.99',
            original_price: '3.49',
            availability: 'in_stock',
            unit: '700g',
            url: 'https://www.loblaws.ca/en/products/whole-wheat-bread',
            discount: '14%',
        },
    ],
    butter: [
        {
            title: 'Salted Butter 454g',
            price: '5.49',
            original_price: '6.49',
            availability: 'in_stock',
            unit: '454g',
            url: 'https://www.loblaws.ca/en/products/butter',
            discount: '15%',
        },
        {
            ...
            availability: 'in_stock',
            unit: '454g',
            url: 'https://www.loblaws.ca/en/products/unsalted-butter',
            discount: '14%',
        },
    ],
    apple: [
        {
            title: 'Red Delicious Apples per lb',
            price: '1.49',
            original_price: '1.99',
            availability: 'in_stock',
            unit: 'lb',
            url: 'https://www.loblaws.ca/en/products/red-apples',
            discount: '25%',
        },
        {
            title: 'Granny Smith Apples per lb',
            price: '1.39',
            original_price: '1.89',
            availability: 'in_stock',
            unit: 'lb',
            url: 'https://www.loblaws.ca/en/products/granny-smith-apples',
            discount: '26%',
        },
    ],
};
